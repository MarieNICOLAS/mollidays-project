"""
Django settings for mollidays project.
...
SECRET_KEY = 'django-insecure-+4tm_-)i&%^!)ta&%^f=#-q*s#ncd0hckgx)rkv314n0(0ljl8'
...
WSGI_APPLICATION = 'mollidays.wsgi.application'
